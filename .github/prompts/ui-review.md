...
Scope: review changes under `ui/**`. Treat `ui/src/generated/*` as generated code; do not request manual edits there unless generation is clearly out of sync with source contracts.
