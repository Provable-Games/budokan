 ...
 */
const DEFAULT_ZKPASSPORT_MAINNET_VERIFIER_ADDRESS =
  "0x0453bff1bf79bf1c4417484aafa88f1d16c285567339a0297201a324655cef96";
const DEFAULT_ZKPASSPORT_SEPOLIA_VERIFIER_ADDRESS =
...
export const ZKPASSPORT_VERIFIER_ADDRESSES: Record<string, string> = {
  [ChainId.SN_SEPOLIA]:
    import.meta.env.VITE_ZKPASSPORT_VERIFIER_SEPOLIA ||
    DEFAULT_ZKPASSPORT_SEPOLIA_VERIFIER_ADDRESS,
  [ChainId.SN_MAIN]:
    import.meta.env.VITE_ZKPASSPORT_VERIFIER_MAINNET ||
    DEFAULT_ZKPASSPORT_MAINNET_VERIFIER_ADDRESS,
};
