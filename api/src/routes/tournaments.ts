...
function serializeRewardClaim(r: typeof rewardClaims.$inferSelect) {
  return {
    ...
    prizeId: r.prizeId?.toString() ?? null,
    payoutIndex: r.payoutIndex,
    position: r.position,
    refundTokenId: r.refundTokenId,
    claimed: r.claimed,
...
function serializeQualificationEntry(q: typeof qualificationEntries.$inferSelect) {
  return {
    ...
    qualificationKind: q.qualificationKind,
    nftTokenId: q.nftTokenId,
    extensionConfig: q.extensionConfig,
