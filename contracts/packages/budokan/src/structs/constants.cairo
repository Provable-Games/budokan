...
// Maximum periods
pub const MAX_REGISTRATION_PERIOD: u32 = 7776000; // 90 days
pub const MAX_TOURNAMENT_LENGTH: u32 = 31536000; // 365 days
pub const MAX_SUBMISSION_PERIOD: u32 = 7776000; // 90 days
