...
// Comparison test between Cubit and Decimal implementations

use budokan_distribution::models::Distribution;
use budokan_distribution::{calculator, calculator_decimal};

const BASIS_POINTS_U32: u32 = 10000;
const BASIS_POINTS_U16: u16 = 10000;

#[test]
fn test_cubit_vs_decimal_comparison() {
    println!("\n=== CUBIT vs DECIMAL COMPARISON ===\n");
    ...
    let weights = array![10_u16, 15, 20, 25]; // 1.0, 1.5, 2.0, 2.5
    let mut i = 0;
    loop {
        if i >= weights.len() {
            break;
